...
export const listaBag = defineStore('listaBag', {
    state: () => ({
        listaBagData: null
    }),

    actions: {
        async listaBag(params = {}) {
            try {
                ...
                const api = mande(`${import.meta.env.VITE_JAVA_API_BASE_URL}/getListaBag${query}`, {
                    headers: {
