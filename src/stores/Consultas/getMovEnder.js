...
export const movEnder = defineStore('movEnder', {
    state: () => ({
        movEnderData: null
    }),
    ...
    actions: {
        async movEnder(params = {}) {
            try {
                ...
                const api = mande(`${import.meta.env.VITE_JAVA_API_BASE_URL}/getMovEnder${url}`, {
                    headers: {
